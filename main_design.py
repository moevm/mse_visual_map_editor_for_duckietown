...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layer_info_browser = QtWidgets.QTextBrowser(self.dockWidgetContents_4)
        self.layer_info_browser.setAutoFillBackground(False)
        self.layer_info_browser.setObjectName("layer_info_browser")
        self.verticalLayout_4.addWidget(self.layer_info_browser)
